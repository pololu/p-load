...
<body>
<p>
  The Pololu USB Bootloader Utility (p-load) is licensed under the same license
  as libusbp (see below).
<p>
  Source code and instructions for building this software can be found in the
  <a href="https://github.com/pololu/p-load">p-load</a> repository.
<p>
  This release was built from
  <a href="https://github.com/pololu/p-load/tree/#{ENV.fetch('commit')}">
  p-load commit #{ENV.fetch('commit')[0, 7]}</a>,
